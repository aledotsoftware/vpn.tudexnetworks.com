...
COPY ./config/config.yaml /etc/headscale/
COPY ./config/dashboard.html /etc/headscale/
COPY ./config/admin-panel.html /etc/headscale/
COPY ./config/acl.hujson /etc/headscale/
COPY ./config/domain-map.txt /etc/headscale/
